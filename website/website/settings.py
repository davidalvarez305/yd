...
GOOGLE_ADS_CLIENT_ID = env.get('GOOGLE_ADS_CLIENT_ID')
GOOGLE_ADS_CLIENT_SECRET = env.get('GOOGLE_ADS_CLIENT_SECRET')
GOOGLE_ADS_REFRESH_TOKEN = env.get('GOOGLE_ADS_REFRESH_TOKEN')

GENERATE_LEAD_GOOGLE_ADS_CONVERSION_ACTION_ID = 6960240237
INVOICE_SENT_GOOGLE_ADS_CONVERSION_ACTION_ID = 7198089328
EVENT_BOOKED_GOOGLE_ADS_CONVERSION_ACTION_ID = 7198233993
...
DEFAULT_TRACKING_NUMBER = '+17869987919'
